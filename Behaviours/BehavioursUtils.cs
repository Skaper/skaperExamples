...
using ExampleApp.Core.Behaviours;
    ...
    public static class BehavioursUtils
    {
        ...
        private static IEnumerable<Type> ParseMethodsForEnums(IEnumerable<MethodInfo> methodInfos)
        {
            ...
            foreach (var methodInfo in methodInfos)
            {
                var enums = methodInfo.GetParameters()
                    .Where(x => x.ParameterType.Namespace.StartsWith("ExampleApp.Core.Behaviours") && x.ParameterType.BaseType == typeof(Enum))
        ...
        private static IEnumerable<Type> ParsePropertiesForEnums(IEnumerable<PropertyInfo> propertyInfos)
        {
            ...
            foreach (var propertyInfo in propertyInfos)
            {
                ...
                if (propertyType.Namespace != null && propertyType.Namespace.StartsWith("ExampleApp.Core.Behaviours") && propertyType.BaseType == typeof(Enum))
                {
